		...
		<form action="#" method="post" name="cf7-any-api-data">
			...
			<div class="cf7-any-api-modal-body">
				...
				<ul id="cf7-any-api-list">
					<li class="reason">
			            <label>
			                <input type="radio" name="selected-reason" value="I found a better plugin." required>
			        ...
			        <li class="reason feedback">
			        	<label>
			        		<span><?php esc_html_e( 'Feedback Answer', 'contact-form-to-any-api' ); ?></span>
			        		<textarea name="comment" required placeholder="Enter Feedback Answer"></textarea>
			        	</label>
			        </li>
			        <?php 
			        ...
			        <li class="reason email">
			            <label>
			                ...
			                <input type="email" name="selected-email" value="<?php echo ($current_user->user_email) ? $current_user->user_email : '';?>" placeholder="Enter Email Address" required>
			            </label>
			        </li>
			    </ul>
			</div>
